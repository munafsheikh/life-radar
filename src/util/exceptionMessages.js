const ExceptionMessages = {
  TOO_MANY_QUADRANTS: 'There are more than 4 sector names listed in your data. Check the sector column for errors.',
  ...
  LESS_THAN_FOUR_QUADRANTS:
    'There are less than 4 sector names listed in your data. Check the sector column for errors.',
